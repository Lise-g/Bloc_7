...
engine = create_engine('postgresql://xxxxxxxxxxxxxxxxxxxxx@ec2-52-215-68-14.eu-west-1.compute.amazonaws.com:5432/xxxxxxxxxxxxx')
...
for i in range(5):
    title = df.iloc[0,i+1]
    url = f'http://www.omdbapi.com/?apikey=9c0d41cf&t={title}'
